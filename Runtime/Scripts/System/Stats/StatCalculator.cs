    ...
    public class StatCalculator
    {
        ...
        public void AddModifier(string statName, StatsModifier modifier)
        {
            if (stats.ContainsKey(statName))
            {
                ...
                OSK.Logg.Log(
                    $"{modifier.modifierType} modifier of {modifier.Value} applied to {statName}. New value: {GetFinalStatValue(statName)}");
            }
        }
        ...
        public void RemoveModifier(string statName, StatsModifier modifier)
        {
            if (stats.ContainsKey(statName))
            {
                ...
                OSK.Logg.Log(
                    $"{modifier.modifierType} modifier of {modifier.Value} removed from {statName}. New value: {GetFinalStatValue(statName)}");
            }
        }
